...
async def user_listing(
    ...
    count_payload = json.dumps({
        ...
        "p_end_date": end_date,
        "p_project_filter": project_filter,
    ...
    total_count = count_response.json() if count_response.status_code == 200 else 0
...
async def user_summary(
    ...
    rpc_name = "get_user_daily_summary" if period == "daily" else "get_user_weekly_summary"
    
    # Convert dates to proper format
    params = {
        "p_user_id": user_id,
        "p_client_filter": client,
        "p_project_filter": project,
        "p_start_date": start_date,
        "p_end_date": end_date
    }
